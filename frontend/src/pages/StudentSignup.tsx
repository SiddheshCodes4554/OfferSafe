    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-surface-elevated p-8">
          ...
          <p className="text-sm text-text-muted mb-8">Free forever — verify unlimited offer letters</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold uppercase tracking-widest text-text-muted mb-2">Full Name</label>
              <input
                type="text"
                required
                value={fullName}
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-widest text-text-muted mb-2">College Name</label>
              <input
                type="text"
                value={college}
